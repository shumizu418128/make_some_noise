...
async def on_message(message):
    ...
    if message.content.startswith("s.battle"):
        ...
        await message.channel.send(embed=embed)
        sleep(10)
        audio = discord.PCMVolumeTransformer(discord.FFmpegPCMAudio("round2switch.mp3"), volume=2)
        ...
        await message.channel.send(embed=embed)
        sleep(10)
        audio = discord.PCMVolumeTransformer(discord.FFmpegPCMAudio("round3switch.mp3"), volume=2)
        await message.channel.send("----------\n\nTIME!\nRound3 SWITCH!\n\n----------")
        message.guild.voice_client.play(audio)
        sleep(3)
        sleep(10)
        ...
        await message.channel.send(embed=embed)
        sleep(10)
        audio = discord.PCMVolumeTransformer(discord.FFmpegPCMAudio("round4switch.mp3"), volume=2)
        await message.channel.send("----------\n\nTIME!\nRound4 SWITCH!\n\n----------")
        message.guild.voice_client.play(audio)
        sleep(3)
        sleep(10)
